...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ResultViewHolder> implements Filterable {
	...
	public void onBindViewHolder(ResultViewHolder viewHolder, int position) {
		...
		if (itemTextLower.contains(key) && !key.isEmpty()) {
			...
			s.setSpan(new ForegroundColorSpan(SearchView.getTextHighlightColor()), itemTextLower.indexOf(key),
					itemTextLower.indexOf(key) + key.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
